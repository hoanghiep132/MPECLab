...
CREATE TABLE `Giao_Hang` (
  ...
  KEY `fk_Giao_Hang_1_idx` (`id_hoa_don`),
  CONSTRAINT `fk_Giao_Hang_1` FOREIGN KEY (`id_hoa_don`) REFERENCES `Hoa_Don` (`id_hoa_don`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-03-24 18:32:57
